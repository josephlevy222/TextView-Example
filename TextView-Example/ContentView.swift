...
let aText: AttributedString = AttributedString("Big").setFont(to: .largeTitle).setItalic() + (AttributedString(" Hello,",attributes: AttributeContainer().kern(3)).setFont(to: .title2).setItalic()
